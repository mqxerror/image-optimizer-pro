        ...
        <CardContent className="space-y-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Connect your Shopify stores for product image optimization</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-slate-900">Prompt Templates</p>
                <p className="text-sm text-slate-500">Create and manage AI prompt templates</p>
              </div>
            </div>
            <ChevronRight className="h-5 w-5 text-slate-400" />
          </Link>
