    ...
    <nav className="space-y-6">
      ...
      <div className="hidden md:block space-y-6">
        {settingsNav.map((group) => (
          <div key={group.group}>
            <h3 className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2 px-3">
              {group.group}
            </h3>
                  ...
                  {({ isActive }) => (
                    <>
                      <div className={cn(
                        ...
                        <item.icon className={cn("h-4 w-4", isActive ? "text-purple-600" : "text-slate-500")} />
                      </div>
